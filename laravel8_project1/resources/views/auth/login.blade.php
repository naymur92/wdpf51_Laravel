  ...
  <div class="nk-app-root">
    ...
    <div class="nk-main ">
      ...
      <div class="nk-wrap nk-wrap-nosidebar">
        <!-- content @s -->
        <div class="nk-content d-flex align-items-center">
          <div class="nk-block-area nk-block-area-column nk-auth-container bg-white">
            ...
            <div class="nk-block nk-block-middle nk-auth-body">
              ...
              <form action="{{ url('/authlogin') }}" method="post" class="form-validate is-alter" autocomplete="off">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="email" name="email" class="form-control form-control-lg" id="email-address"
              ...
              <div class="form-note-s2 pt-4"> New on our platform? <a href="html/pages/auths/auth-register.html">Create
                  an account</a>
              </div>
